...
SAMPLE_CSV = """title,genres,description,rating
...
st.caption("Runs in sandbox and Streamlit Cloud. Upload your CSV or use sample data.")
...
required_help = "Needs `title` and ideally `genres`, `description`, and optional `rating`."
st.write(f"Dataset columns: {', '.join(df.columns)}")
st.caption(required_help)
